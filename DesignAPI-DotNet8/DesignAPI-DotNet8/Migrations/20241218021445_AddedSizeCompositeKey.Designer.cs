...
namespace DesignAPI_DotNet8.Migrations
{
    ...
    [Migration("20241218021445_AddedSizeCompositeKey")]
    partial class AddedSizeCompositeKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DesignAPI_DotNet8.Models.Sizes.Size", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("ProductTypesIds")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("SizeName", "DimensionTypeId")
                        .IsUnique()
                        .HasFilter("[DimensionTypeId] IS NOT NULL");
            ...
            modelBuilder.Entity("DesignAPI_DotNet8.Models.Sizes.SizeRangeCategory", b =>
                {
                    ...
                    b.ToTable("SizeRangeCategegories", (string)null);
                });
